...
class APIService {
  ...
  Future<http.Response> signup(Map body) async {
    return await http.post(
      Uri.parse('${baseURL}backend/auth/register'),
      headers: {
  ...
  Future<http.Response> login(Map body) async {
    return await http.post(
      Uri.parse('${baseURL}backend/auth/login'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
      },
  ...
  Future<http.Response> forgotPass(Map body) async {
    return await client.post(
      Uri.parse('${baseURL}backend/password/email'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
      },
  ...
  Future<http.Response> verify(Map body, var accessToken) async {
    return await http.post(
      Uri.parse('${baseURL}backend/verification/verify'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> resendOTP(var accessToken) async {
    return await http.post(
      Uri.parse('${baseURL}backend/verification/resend'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> setWalletPIN(Map body, var accessToken) async {
    return await http.put(
      Uri.parse('${baseURL}backend/user/wallet/pin'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> withdrawWallet(Map body, var accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/withdraw'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
        "Authorization": "Bearer " + accessToken,
  ...
  Future<http.Response> changeWalletPIN(Map body, var accessToken) async {
    return await client.put(
      Uri.parse('${baseURL}backend/user/wallet/change_pin'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
        "Authorization": "Bearer " + accessToken,
  ...
  Future<http.Response> resetWalletPIN(var accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/user/wallet/reset'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
        "Authorization": "Bearer " + accessToken,
  ...
  Future<http.Response> confirmResetWalletPIN(Map body, var accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/user/wallet/confirm_reset'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
        "Authorization": "Bearer " + accessToken,
  ...
  Future<http.Response> getProfile(String accessToken) async {
    return await client.get(
      Uri.parse('${baseURL}backend/user/profile'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> logout(String accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/auth/logout'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future getProducts() async {
    return await http.get(
      Uri.parse('${baseURL}backend/products'),
      headers: {
        "Content-type": "application/json",
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
      },
  ...
  Future getTransactions(String accessToken) async {
    return await client.get(
      Uri.parse('${baseURL}backend/user/transactions'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  fetchNextTransactions(String accessToken, int currentPage) async {
    final response = await client.get(
      Uri.parse('${baseURL}backend/user/transactions?page=$currentPage'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> transaction(Map body) async {
    return await client.post(
      Uri.parse('${baseURL}backend/user/transaction'),
      headers: {
        "Content-type": "application/json",
        // "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future cancelTransaction(String accessToken, transRef) async {
    return await client.post(
      Uri.parse('${baseURL}backend/transaction/$transRef/cancel'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> guestBuy(Map body) async {
    return await http.post(
      Uri.parse('${baseURL}backend/anonymous/buy'),
      headers: {
        "Content-type": "application/json",
        // "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> guestTransaction(Map body) async {
    return await http.post(
      Uri.parse('${baseURL}backend/anonymous/transaction'),
      headers: {
        "Content-type": "application/json",
        // "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> guestPayment(Map body) async {
    return await http.post(
      Uri.parse('${baseURL}backend/anonymous/transaction/payment'),
      headers: {
        "Content-type": "application/json",
        // "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> payment(Map body, String accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/user/transaction/payment'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> kyc(Map body, String accessToken) async {
    return await client.put(
      Uri.parse('${baseURL}backend/user/kyc'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> updatePassword(Map body, String accessToken) async {
    return await client.put(
      Uri.parse('${baseURL}backend/user/password'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> fundWalletRequest(Map body, String accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/user/fund_wallet_request'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> airtimeCash(String accessToken) async {
    return await client.get(
      Uri.parse('${baseURL}backend/init?section=airtime_to_cash'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
  ...
  Future<http.Response> airtimeCashRequest(Map body, String accessToken) async {
    return await client.post(
      Uri.parse('${baseURL}backend/transaction/airtime-to-cash'),
      headers: {
        "Content-type": "application/json",
        "Authorization": "Bearer " + accessToken,
        "HTTP-REQUEST-SOURCE": "mobile:${_controller.appVersion.value}",
